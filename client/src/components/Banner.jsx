...
const Banner = ({query, handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto x1:px-24 px-14 md:py-20 py-14'>
        <h1 className='text-5xl font-bold text-primary mb-3'>Riding the Wave to Your <span className='text-blue'>Dream Job</span> Today</h1>
        <p className='text-lg text-black mb-8'>Try Work Wave and ride the wave to your career success!</p> 
