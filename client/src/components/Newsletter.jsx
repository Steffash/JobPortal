  ...
  return (
    <div>
        <div>
            ...
            <p className="text-primary/75 text-base mb-4">Stay ahead of the curve by subscribing to our job alerts. Receive the latest job openings directly to your inbox and never miss out on a great opportunity.</p>
        ...
        <div className="mt-20">
            ...
            <p className="text-primary/75 text-base mb-4">Increase your chances of being discovered by companies looking for talent like you.</p>
